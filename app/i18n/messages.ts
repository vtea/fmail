...
const en: Dictionary = {
	home: {
		...
		restoring: "Restoring...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
...
const es: Dictionary = {
	home: {
		...
		restoreDivider: "Usar una dirección existente",
		restoreAddress: "Restaurar dirección",
		restoring: "Restaurando...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "Dirección no válida",
		restoreHint:
			"Introduce la dirección original para reabrir esta bandeja. Los mensajes se eliminan a las 24 horas.",
		issueFailed: "No se pudo generar una dirección nueva. Inténtalo de nuevo.",
		modal: {
			title: "Vista previa",
			from: "De",
			time: "Hora",
...
const fr: Dictionary = {
	home: {
		...
		restoreDivider: "Utiliser une adresse existante",
		restoreAddress: "Restaurer l'adresse",
		restoring: "Restauration...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "Adresse invalide",
		restoreHint:
			"Saisissez l'adresse d'origine pour rouvrir cette boîte. Les messages sont encore supprimés après 24h.",
		issueFailed: "Impossible de générer une nouvelle adresse. Réessayez.",
		modal: {
...
const de: Dictionary = {
	home: {
		...
		restoreDivider: "Vorhandene Adresse nutzen",
		restoreAddress: "Adresse wiederherstellen",
		restoring: "Wird wiederhergestellt...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "Ungültige Adresse",
		restoreHint:
			"Gib die ursprüngliche Adresse ein, um dieses Postfach erneut zu öffnen. Nachrichten werden nach 24h entfernt.",
		issueFailed: "Neue Adresse konnte nicht erzeugt werden. Bitte erneut versuchen.",
		modal: {
...
const ja: Dictionary = {
	home: {
		...
		restoreDivider: "既存のアドレスを使う",
		restoreAddress: "アドレスを復元",
		restoring: "復元中...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "アドレスの形式が正しくありません",
		restoreHint:
			"元のアドレスを入力すると、この受信箱を再度開けます。メールは約24時間で削除されます。",
		issueFailed: "新しいアドレスを生成できませんでした。再試行してください。",
		modal: {
			title: "メッセージプレビュー",
			from: "差出人",
			time: "時刻",
...
const ko: Dictionary = {
	home: {
		...
		restoreDivider: "기존 주소 사용",
		restoreAddress: "주소 복원",
		restoring: "복원 중...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "주소 형식이 올바르지 않습니다",
		restoreHint:
			"원래 주소를 입력하면 이 메일함을 다시 열 수 있습니다. 메일은 약 24시간 후 삭제됩니다.",
		issueFailed: "새 주소를 만들지 못했습니다. 다시 시도하세요.",
		modal: {
			title: "메일 미리보기",
			from: "보낸사람",
			time: "시간",
...
const ru: Dictionary = {
	home: {
		...
		restoreDivider: "Использовать существующий адрес",
		restoreAddress: "Восстановить адрес",
		restoring: "Восстановление...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "Некорректный адрес",
		restoreHint:
			"Введите исходный адрес, чтобы снова открыть этот ящик. Письма удаляются примерно через 24 часа.",
		issueFailed: "Не удалось создать новый адрес. Попробуйте ещё раз.",
		modal: {
			title: "Предпросмотр",
			from: "От",
			time: "Время",
...
const pt: Dictionary = {
	home: {
		...
		restoreDivider: "Usar um endereço existente",
		restoreAddress: "Restaurar endereço",
		restoring: "Restaurando...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "Endereço inválido",
		restoreHint:
			"Digite o endereço original para reabrir esta caixa. As mensagens ainda são removidas após cerca de 24h.",
		issueFailed: "Não foi possível gerar um novo endereço. Tente novamente.",
		modal: {
...
const ar: Dictionary = {
	home: {
		...
		restoreDivider: "استخدام عنوان موجود",
		restoreAddress: "استعادة العنوان",
		restoring: "جارٍ الاستعادة...",
		restorePlaceholder: "name-xxxxxx@smail.pw",
		restoreInvalid: "العنوان غير صالح",
		restoreHint:
			"أدخل العنوان الأصلي لإعادة فتح هذا الصندوق. تُحذف الرسائل بعد نحو 24 ساعة.",
		issueFailed: "تعذر إنشاء عنوان جديد. حاول مرة أخرى.",
		modal: {
