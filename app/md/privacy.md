...
- **Email content**: The emails sent to your temporary addresses are stored on our servers for a short time so that you can read them.
...
- **Temporary inboxes and emails** are kept only for a short time and may be deleted at any moment, with or without notice.
...
We may share or preserve information when necessary to:
...
If the changes are material, we may provide additional notice where reasonable.
